    ...
    "paths": {
        ...
        "/environments": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "list every environment instead of only the caller's; requires the admin role",
                        "name": "all",
                        "in": "query"
                    }
                ],
        ...
        "/environments/{id}/effects": {
            "get": {
                ...
                "description": "Which context keys, assets and zones drive which others, derived from the stored definition alone: script reads and writes of foreign state, formula inputs, schedule gates and scales, the meter tree and its aggregates, and the dated changes of the timeline. Edges point from the producer to the consumer.\n\nA script is analysed, not run. A reference whose zone, asset or key is not a string literal, an alias of one or a row of a literal table is listed under ` + "`" + `unresolved` + "`" + ` with the reason instead of being guessed; the rest of the graph is derived all the same.\n\nAccess is that of GET /environments/{id}: a missing environment and one the caller may not see are both 404. See docs/effects.md.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/environments/{id}/history": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "the timescale did not answer in time, so the window could not be checked; retry or send force: true",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "effects.Edge": {
            ...
            "properties": {
                ...
                "from": {
                    "type": "string",
                    "example": "asset:a-pv-a"
                },
                "key": {
                    "description": "Key is the state or context key that is read or written, the channel id a\nformula reads, or the target of a dated change.",
                    "type": "string",
                    "example": "pv_w"
                },
                "kind": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/effects.EdgeKind"
                        }
                    ],
                    "example": "reads"
                },
        ...
        "effects.Graph": {
            ...
            "properties": {
                "edges": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/effects.Edge"
                    }
                },
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/effects.Node"
                    }
                },
                "unresolved": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/effects.Unresolved"
                    }
                }
            }
        },
        "effects.Node": {
            ...
            "properties": {
                "asset_kind": {
                    "description": "AssetKind is set on an asset.",
                    "type": "string",
                    "example": "inverter"
                },
                "external_ref": {
                    "description": "ExternalRef is set on a context key: the ref of a dataset source, else empty.",
                    "type": "string",
                    "example": ""
                },
                "id": {
                ...
                "kind": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/effects.NodeKind"
                        }
                    ],
                    "example": "asset"
                },
                "label": {
                    "type": "string",
                    "example": "PV-Wechselrichter"
                },
                "site": {
                    "description": "Site is set on an asset and on a zone: the top level zone above it.",
                    "type": "string",
                    "example": "z-standort-a"
                },
                "source_kind": {
                    "description": "SourceKind is set on a context key: the kind of the context source driving\nit, empty when none does.",
                    "type": "string",
                    "enum": [
                        "profile",
                        "dataset",
                ...
                "static": {
                    "description": "Static is set on a context key: true when the key is declared in context\nand no context source drives it.",
                    "type": "boolean",
                    "example": false
                },
                "zone": {
                    "description": "Zone is set on an asset (the zone it sits in) and on a zone (its own id).",
                    "type": "string",
                    "example": "z-standort-a"
                }
            }
        ...
        "effects.Unresolved": {
            ...
            "properties": {
                ...
                "reason": {
                    "type": "string",
                    "example": "the key is computed at run time"
                }
            }
        },
        "effects.Via": {
